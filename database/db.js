...
class DatabaseConnection {
    constructor() {
        ...
        // Handle application termination //if my application stops, i should stop my mongodb
    ...
    async handleConnectionError() {
        if (this.retryCount < MAX_RETRIES) {
            ...
            await new Promise(resolve => setTimeout(resolve, RETRY_INTERVAL));  // just to wait sometime
            return this.connect();
        } else {
